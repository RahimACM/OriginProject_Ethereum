...
contract MainContract {
    ...
    function getPathAtIndex(uint _productId, uint index) public view returns(address, address, string, string, string) {
        return (productStructs[_productId].fromPath[index], productStructs[_productId].toPath[index], productStructs[_productId].positionPath[index], productStructs[_productId].timePath[index], productStructs[_productId].messagePath[index]);
    }
